...
namespace MediaMatch.App.macOS;

/// <summary>
/// macOS application entry point. Mirrors the Windows App.xaml.cs composition root
...
public partial class App : Microsoft.UI.Xaml.Application
{
    ...
    public App()
    {
        ...
        Log.Information("MediaMatch macOS application started");
    }
