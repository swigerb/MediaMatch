...
public partial class AboutViewModel : ViewModelBase
{
    ...
    public string AppName => "Media Match";
    ...
    public string Description => "A modern, open-source media file organizer and renamer. " +
        "Media Match identifies TV episodes and movies, fetches metadata from online databases, " +
    ...
    public string Copyright => $"© {DateTime.Now.Year} Media Match Contributors";
